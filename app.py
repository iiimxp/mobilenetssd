...
lineaccesstoken = '2mqCYvLBXj8OLD0g47YsaDCJDp/ctdjis1cs67NmqVCHWbnYjk1MZ5oY6e7321eT7I+Ab7jXWziDv194dcoiMyFtIWkBpEmrzLh8tRL7hyTWOk/gs2WTeepMtfaXJsmdTzJlNY7bPzRQmTuEMQfSGQdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "ดีจ้า":
           replyObj = TextSendMessage(text="มีอะไรไหมคะ")
           line_bot_api.reply_message(rtoken, replyObj)
       elif msg == "หิว":
           replyObj = TextSendMessage(text="อย่าลืมกินข้าวด้วยนะ")
           line_bot_api.reply_message(rtoken, replyObj)
       elif msg == "น่ารักจัง":
           replyObj = TextSendMessage(text="ขอบคุณค่า")
           line_bot_api.reply_message(rtoken, replyObj)
       else :
           headers = request.headers
           json_headers = ({k:v for k, v in headers.items()})
           json_headers.update({'Host':'bots.dialogflow.com'})
           url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/d3f4ee99-92dd-42f0-af4b-9f1d531ace26"
